...
#ifndef MOBILITY_GRADIENT_NANO_ROUTING_ENTITY_H
#define MOBILITY_GRADIENT_NANO_ROUTING_ENTITY_H
...
namespace ns3 {
	 ...
	 *
	 */
	class MobilityGradientNanoRoutingEntity: public NanoRoutingEntity {
	public:
		static TypeId GetTypeId(void);

		MobilityGradientNanoRoutingEntity(void);
		virtual ~MobilityGradientNanoRoutingEntity(void);
...
#endif /* MOBILITY_GRADIENT_NANO_ROUTING_ENTITY_H */
